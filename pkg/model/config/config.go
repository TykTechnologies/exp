...
type Config struct {
	...
	EventTriggers any `json:"event_trigers_defunct"` // Deprecated: Config.GetEventTriggers instead.

	EventTriggersDefunct any `json:"event_triggers_defunct"` // Deprecated: Config.GetEventTriggers instead.
...
type ConsulConfig struct {
	...
	HttpAuth struct{} `json:"http_auth"`
	...
	// TLS configuration
	TLSConfig struct{} `json:"tls_config"`
}
